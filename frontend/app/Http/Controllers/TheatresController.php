...
class TheatresController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // $theatre = json_decode($response->getBody());
        return redirect()->route('theatres.index')->with('success', 'theatre has been edited');
    }
...
/*------------------------SCREENS-----------------------*/
    ...
    public function store_schedule(Request $request, $theatre_id){
        ...
        // $theatre = json_decode($response->getBody());
        return redirect()->route('schedule.index', $theatre_id)->with('success', 'New screen has been added');
    }
